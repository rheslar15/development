...
{
    public class PhotologReport : IReportHandler
    {
		...
		/// <summary>
		/// Generates the photoLog report.
		/// </summary>
		/// <returns>The log view.</returns>
		/// <param name="inspectionObject">Inspection object.</param>
  //      public PdfPTable PhotoLogView(Inspection inspectionObject)
		...
		public PdfPTable PhotoLogView(Inspection inspectionObject)
		{
			...
			PdfPCell Blankcell = new PdfPCell(new Phrase(" ", headerFont));
			Blankcell.FixedHeight = 30;
			Blankcell.BorderWidth = 0;
			Blankcell.Colspan = 4;
			ParentTable.AddCell(Blankcell);
